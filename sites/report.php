...
<body>
	<div id = "info">
		...
		<?php
			...
			$sql = 'select * from assets where length(asset_tag) < 6 and asset_tag not like "%TV%" and deleted_at is null and assets.asset_tag != assets.serial and asset_tag not in (select name from tempExclusions) and serial not in (select name from tempExclusions);';
		...
		<?php
			...
			$sql = 'select * from assets where length(asset_tag) < 9 and asset_tag not like "%TV%" and asset_tag not like "%TC%" and deleted_at is null and assets.asset_tag != assets.serial and asset_tag not in (select name from tempExclusions) and serial not in (select name from tempExclusions);';
