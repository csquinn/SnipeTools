...
<body>
	...
	<h1>SnipeTools</h1>
	<?php echo ((time()-filemtime("../snipe-it/.github") > 3600)?("<h3 style='color: #FF474C;'>SnipeIT hasn't been updated in over a month. Please remote into<br>this server and run the SnipeIT update script on the Desktop.</h3>"):("")); ?>
